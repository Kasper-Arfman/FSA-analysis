...
T = 100
DNA_BLUR = (1, 4, 4)  # (1, 1, 1) 
DNA_STRICTNESS = 0.5  #0.40
NOISE_PERCENTILE = 50
SIGNAL_PERCENTILE = 94
...
def measure_length_bead(path: str):
    ...
    dna_threshold = sum([
        (1-DNA_STRICTNESS)*np.percentile(img_blurred[10], NOISE_PERCENTILE), 
...
if __name__ == "__main__":
    ...
    paths = [
        (r"data\Force extension_ramp001_37x68y_free.tif", 0, None),
        (r"data\Force extension_ramp001_41x84y_free.tif", 0, None),
        (r"data\Force extension_ramp001_72x79y_free.tif", 0, None),
    ]

    paths += [
        (r"data\Force extension_ramp001_59x127y_bead.tif", 0, None),
        (r"data\Force extension_ramp001_115x48y_bead_3.tif", 0, None),  # _3
        (r"data\Force extension_ramp001_146x70y_bead.tif", 0, None),
    ]
